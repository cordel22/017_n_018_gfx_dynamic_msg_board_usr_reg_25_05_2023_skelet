...
//  Redirect if this page is called directly:
  if (!isset($words)) {
    header ("Location: http://localhost:/index.php");  //  header ("Location: http://www.example.com/index.php");
    exit();
  }
  ...
  if (isset($_SESSION['user_id'])) {
    //  Display the form:
      ...
      if (isset($tid) && $tid) {
        ...
        echo '<p><em>' . $words['subject'] . '</em>: <input name="subject" type="text" size="60" maxlengh="100" ';
